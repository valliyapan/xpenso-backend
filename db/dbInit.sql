...
CREATE INDEX IF NOT EXISTS expenses_idx ON expenses (user_id, expense_date);
...
CREATE INDEX IF NOT EXISTS credits_idx ON credits (user_id, credit_date);

CREATE TABLE IF NOT EXISTS alarms (
    user_id INTEGER NOT NULL,
    name TEXT NOT NULL,
    category_id INTEGER NOT NULL,
    expense_limit MONEY NOT NULL,
